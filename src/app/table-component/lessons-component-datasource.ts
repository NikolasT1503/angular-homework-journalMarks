...
export class LessonsComponentDataSource extends DataSource<Lessons> {
  ...
  private getPagedData(data: Lessons[]) {
 ...
 /*  private getSortedData(data: TableComponentItem[]) { */
  private getSortedData(data: Lessons[]) {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort.active) {
        case 'dateLesson': return compare(a.dateLesson, b.dateLesson, isAsc);
        case 'theme': return compare(a.theme, b.theme, isAsc);
